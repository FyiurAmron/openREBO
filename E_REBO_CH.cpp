...
namespace OpenREBO {
  ...
  void AIREBO::REBO_neighbours_CH( ) {
  ...
  double AIREBO::bond_order_1_CH( int a1, int a2, int type1, int type2, const double r12_vec[3], double r12, double r12_inv,
  ...
  double AIREBO::bond_order_CH( int a1, int a2, const bond * b ) {
    ...
    double Nconj_tmp1 = bond_order_1_CH( a1, a2, type1, type2, r12_vec, r12, r12_inv, N12C, N12H, N12Total, p12, nt1 ),
            Nconj_tmp2 = bond_order_1_CH( a2, a1, type2, type1, r21_vec, r12, r12_inv, N21C, N21H, N21Total, p21, nt2 );
